...
DIAGRAM_REGISTRY = [
    ...
    DiagramSpec(plot_4panel,     "V_Ti_Sc_ThNb_BaTh_4panel.png",  "四联比值构造判别图",                 ('Ti', 'V', 'Sc', 'Th', 'Nb', 'Ba'),  None,           ("mafic",),
    ...
    DiagramSpec(plot_sm_yb_la_sm, "SmYb_LaSm_partial_melting.png","(Sm/Yb)PM-(La/Sm)PM 部分熔融图",    ('Sm', 'Yb', 'La'), None,                            ("mafic",),
