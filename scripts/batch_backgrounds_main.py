"""
batch_backgrounds_main.py — 批量生成所有图件的纯底图（无数据投点）
...
用法：
    ...
    # minimal 模式（纯 NaN，仅测试）
    python batch_backgrounds_main.py --mode minimal --out-dir /path/to/output

    # 省略 --out-dir，默认 /mnt/c/Users/opcry/Desktop/igenous实验0527/
"""
...
OUT_DIR = '/mnt/c/Users/opcry/Desktop/igenous实验0527'
