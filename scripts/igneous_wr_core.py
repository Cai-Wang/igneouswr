...
from igneous_wr.diagrams.registry import (
    ...
    plot_batchelor, plot_hollocher1, plot_hollocher2,
    plot_maniar, plot_agrawal, plot_verma, plot_larocheplut,
    plot_larochevolc, plot_middlemostplut, plot_layb, plot_ross,
)
